#define TRADER_THIS_TYPE     1          // Credit to Urist McStation for their trading code.
...
#define TRADER_WANTED_ONLY   1 //Do the traders only trade for wanted goods?
#define TRADER_MONEY         2 //Do they only accept money in return for goods.
#define TRADER_GOODS         4 //Do they accept trading other goods for their goods?
